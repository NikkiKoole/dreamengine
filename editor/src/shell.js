...
const sections = [
  ...
  { title: 'graphics',   titleNL: 'tekenen',      keys: ['cls', 'colorkey', 'spr', 'sprf', 'sspr', 'spr_rot', 'sspr_ex', 'pget', 'pset', 'font', 'FONT_NORMAL', 'FONT_SMALL', 'FONT_TINY', 'print', 'print_centered', 'print_right', 'print_scaled', 'print_shadow', 'print_outline', 'text_width', 'rect', 'rectfill', 'bar', 'circ', 'circfill', 'oval', 'ovalfill', 'arc', 'arcfill', 'ring', 'tri', 'trifill', 'tritex', 'line', 'camera', 'camera_ex', 'follow', 'clip', 'pal', 'pal_reset', 'fade', 'shake'] },
  { title: 'shapes',     titleNL: 'vormen',       keys: ['ngon', 'ngonfill', 'star', 'starfill', 'poly', 'polyfill', 'thickline', 'rrect', 'rrectfill', 'vgradient', 'hgradient'] },
