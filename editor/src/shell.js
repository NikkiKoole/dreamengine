...
const sections = [
  ...
  { title: 'graphics',      keys: ['cls', 'colorkey', 'spr', 'sprf', 'sspr', 'spr_rot', 'sspr_ex', 'pget', 'pget_rgb', 'enable_pget', 'pset', 'pset_rgb', 'sget', 'font', 'FONT_NORMAL', 'FONT_SMALL', 'FONT_TINY', 'FONT_LARGE', 'FONT_BOOT', 'FONT_SMOOTH', 'FONT_COMIC', 'FONT_THIN', 'print', 'print_centered', 'print_right', 'print_scaled', 'print_outline', 'text_width', 'rect', 'rectfill', 'rectfill_rgb', 'bar', 'circ', 'circfill', 'oval', 'ovalfill', 'arc', 'arcfill', 'arcoutline', 'ring', 'ringoutline', 'tri', 'trifill', 'tritex', 'line', 'bezier', 'camera', 'camera_ex', 'follow', 'clip', 'zoom_rect', 'pal', 'pal_reset', 'fade', 'shake'] },
  ...
  { title: 'sound',       keys: ['sfx', 'note', 'hit', 'note_on', 'note_off', 'note_pitch', 'note_vol', 'note_cutoff', 'note_duty', 'note_pan', 'note_res', 'note_lfo', 'note_env', 'note_follow', 'note_harmonics', 'note_timbre', 'note_morph', 'voice_nasal', 'voice_consonant', 'voice_coda', 'note_drive', 'note_drive_mode', 'note_echo', 'note_reverb', 'note_filter', 'note_glide', 'note_off_all', 'instrument', 'instrument_duty', 'instrument_pan', 'pan_law', 'instrument_lfo', 'instrument_filter', 'instrument_env', 'instrument_follow', 'instrument_harmonics', 'instrument_timbre', 'instrument_morph', 'instrument_tune', 'instrument_drive', 'instrument_drive_mode', 'instrument_echo', 'instrument_reverb', 'instrument_reverb_bus', 'reverb_bus_fx', 'reverb_insert', 'instrument_chorus', 'instrument_flanger', 'instrument_tape', 'instrument_wah', 'instrument_wah_lfo', 'instrument_crush', 'instrument_eq', 'instrument_tremolo', 'instrument_phaser', 'instrument_leslie', 'instrument_choke', 'echo', 'reverb', 'reverb_bus', 'chorus', 'flanger', 'tape', 'wah', 'wah_lfo', 'crush', 'eq', 'tremolo', 'phaser', 'leslie', 'fx_order', 'wave_set', 'tone', 'chord', 'strum', 'schedule', 'schedule_hit', 'bpm', 'beat', 'beat_pos', 'every', 'euclid', 'chance', 'degree', 'INSTR_SQUARE', 'INSTR_SAW', 'INSTR_TRI', 'INSTR_NOISE', 'INSTR_SINE', 'INSTR_USER0', 'INSTR_USER1', 'INSTR_USER2', 'INSTR_USER3', 'INSTR_PLUCK', 'INSTR_MALLET', 'INSTR_FM', 'INSTR_ORGAN', 'INSTR_EPIANO', 'INSTR_PD', 'INSTR_MEMBRANE', 'INSTR_REED', 'INSTR_PIPE', 'INSTR_VOICE', 'INSTR_GUITAR', 'INSTR_PIANO', 'INSTR_BOWED', 'INSTR_BRASS', 'LFO_PITCH', 'LFO_DUTY', 'LFO_VOLUME', 'LFO_CUTOFF', 'LFO_HARMONICS', 'LFO_TIMBRE', 'LFO_MORPH', 'LFO_PAN', 'PAN_LINEAR', 'PAN_POWER', 'ENV_CUTOFF', 'ENV_PITCH', 'ENV_DUTY', 'ENV_HARMONICS', 'ENV_TIMBRE', 'ENV_MORPH', 'FILTER_OFF', 'FILTER_LOW', 'FILTER_HIGH', 'FILTER_BAND', 'FILTER_NOTCH', 'DRIVE_SOFT', 'DRIVE_HARD', 'DRIVE_FOLD', 'DRIVE_ASYM', 'TREM_SINE', 'TREM_SQUARE', 'TREM_TRI', 'FX_TREM', 'FX_WAH', 'FX_CHORUS', 'FX_PHASER', 'FX_FLANGER', 'FX_TAPE', 'FX_EQ', 'FX_CRUSH', 'FX_REVERB', 'LESLIE_STOP', 'LESLIE_SLOW', 'LESLIE_FAST', 'SCALE_MAJOR', 'SCALE_MINOR', 'SCALE_PENTA', 'SCALE_PENTA_MIN', 'SCALE_BLUES', 'SCALE_CHROMATIC', 'CHORD_MAJ', 'CHORD_MIN', 'CHORD_DIM', 'CHORD_AUG', 'CHORD_MAJ7', 'CHORD_MIN7', 'CHORD_DOM7', 'CHORD_SUS4', 'CHORD_POWER'] },
