...
const sections = [
  ...
  { title: 'input',        keys: ['btn', 'btnp', 'btnr', 'BTN_UP', 'BTN_DOWN', 'BTN_LEFT', 'BTN_RIGHT', 'BTN_A', 'BTN_B', 'BTN_X', 'BTN_Y'] },
  ...
  { title: 'external data', keys: ['de_data_path', 'de_dropped_file', 'de_open_path'] },
