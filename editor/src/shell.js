...
const sections = [
  ...
  { title: 'graphics',   titleNL: 'tekenen',      keys: ['cls', 'colorkey', 'spr', 'sprf', 'sspr', 'pget', 'pset', 'print', 'print_centered', 'print_right', 'rect', 'rectfill', 'bar', 'circ', 'circfill', 'tri', 'trifill', 'line', 'camera', 'follow', 'clip'] },
  ...
  { title: 'utility',    titleNL: 'hulpmiddelen', keys: ['rnd', 'rnd_between', 'rnd_float', 'rnd_float_between', 'now', 'epoch', 'frame', 'sgn', 'mid', 'timer', 'timer_reset'] },
