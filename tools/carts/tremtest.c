...
// A4 sine on INSTR_SINE (no decay tail to muddy the envelope) with tremolo(5.5, 0.7, TREM_SINE).
#include "studio.h"
...
void init(void) {
    ...
    tremolo(5.5f, 0.7f, TREM_SINE);   // 5.5 Hz, 70% depth, sine — the value we verify
